 ...
 */
final class Version20260415105944 extends AbstractMigration
{
    public function getDescription(): string
    {
        return 'Ajoute ovh_id sur redirection pour piloter update/delete OVH.';
    }

    public function up(Schema $schema): void
    {
        // this up() migration is auto-generated, please modify it to your needs
        $this->addSql('ALTER TABLE redirection ADD COLUMN ovh_id VARCHAR(64) DEFAULT NULL');
    }

    public function down(Schema $schema): void
    {
        // this down() migration is auto-generated, please modify it to your needs
        $this->addSql('CREATE TEMPORARY TABLE __temp__redirection AS SELECT id, source_email, destination_email, enabled, created_at, updated_at, email_account_id, owner_id FROM redirection');
        ...
        $this->addSql('INSERT INTO redirection (id, source_email, destination_email, enabled, created_at, updated_at, email_account_id, owner_id) SELECT id, source_email, destination_email, enabled, created_at, updated_at, email_account_id, owner_id FROM __temp__redirection');
